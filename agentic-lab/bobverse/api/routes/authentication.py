...
from bobverse.api.schemas.requests.user import UserLoginRequest, UserRegistrationRequest
from bobverse.api.schemas.responses.user import (
    UserLoginResponse,
    UserRegistrationResponse,
)
from bobverse.core.dependencies import DBSession, IUserAuthService
